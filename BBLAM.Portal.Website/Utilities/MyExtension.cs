...
namespace System
{
    public static class MyExtension
    {
        ...
        private static string[] commands = new string[] { "select", "insert", "update", "delete" };
        ...
        {
            return ChangeType<int>(value.Trim().Replace(",", ""));
        }
        ...
        {
            return ChangeType<double>(value.Trim().Replace(",", ""));
        }
        ...
        public static T ExecuteObject<T>(this OracleConnection conn, string usp, Func<OracleDataReader, T> fillMethod, params OracleParameter[] parameters)
        {
            ...
            {
                if (commands.Any(x => usp.ToLower().StartsWith(x)))
        ...
        {
            return Config<T>(key, default(T));
        }
        public static T Config<T>(string key, T defaultvalue)
        {
