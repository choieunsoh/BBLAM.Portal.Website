<%@ Page Title="Index Simulated Return" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="BBLAM.Web.UI.PageBase" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="heading-title">
                <h4>
                    <i class="fa fa-line-chart"></i> Index Simulated Return
                </h4>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="form-horizontal">
                    <div class="form-group search-group">
				        ...
				        <div class="col-xs-8">		
                            <select class="selectpicker show-tick" id="ddlIndexCode" title="Please select index" data-width="100%" data-live-search="true"></select>
				        </div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script src="<% =ResolveUrl("scripts/index-sim.js")%>"></script>
</asp:Content>
