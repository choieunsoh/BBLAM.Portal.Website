    ...
    <div class="row">
        ...
        <div class="col-xs-12 form-data-wrapper">
            <div class="col-lg-6 col-sm-12">
                <div class="form-horizontal">
                    <div class="form-group search-group">
                        <label class="col-xs-4 control-label">Data Type :</label>
				        <div class="col-xs-8">		
                            <select class="selectpicker show-tick" id="ddlDataType" title="Please select data type" data-width="100%">
                                <option value="CLOSED_PRICE">Closed Price</option>
                                <option value="INDEX_RETURN">Return</option>
                            </select>
				        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script src="<% =ResolveUrl("scripts/index-data.js")%>"></script>
</asp:Content>
