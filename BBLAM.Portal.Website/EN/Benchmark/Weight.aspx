<%@ Page Title="Benchmark Component Setting" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="BBLAM.Web.UI.PageBase" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="heading-title">
                <h4>
                    <i class="fa fa-pie-chart"></i> Benchmark Component Setting
                </h4>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
				            ...
				            <div class="col-xs-8">		
					            <input type="text" class="form-control bold upper" data-field="bm_code" maxlength="20" placeholder="Enter benchmark code" disabled />
				            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
				            ...
				            <div class="col-xs-8">		
					            <input type="text" class="form-control dialog-weight" data-field="weight" maxlength="20" data-format="p2" placeholder="Enter weight"   />
				            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <form id="formUpload">
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Benchmark Weight CSV File :</label>
				            <div class="col-xs-8">		
...
<pre class="code">
    ...
    <code></code>
    <code>"BM_CODE","INDEX_CODE","WEIGHT"</code>
    <code>"XXX","XXX","100"</code>
    <code></code>
    <code>Remark: weight in %</code>
    <code></code>
    <code>Ex.</code>
    <code>"MF-EQ-01","SET","100"</code>
    <code>"MF-EQ-02","SET-TRI","50"</code>
    <code>...</code>
    <code></code>
</pre>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script src="<% =ResolveUrl("scripts/weight.js")%>"></script>
</asp:Content>
