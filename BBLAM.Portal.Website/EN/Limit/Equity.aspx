<%@ Page Title="Equity Limit" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="BBLAM.Web.UI.PageBase" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="heading-title">
                <h4>
                    <i class="fa fa-cogs"></i> Equity Limit
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <form id="formMain">
                ...
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Min Limit :</label>
				            <div class="col-xs-8">		
					            <input type="text" class="form-control dialog-limit" data-field="min_limit" maxlength="20" data-format="n6" placeholder="Enter equity min limit"   />
				            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Max Limit :</label>
				            <div class="col-xs-8">		
					            <input type="text" class="form-control dialog-limit" data-field="max_limit" maxlength="20" data-format="n6" placeholder="Enter equity max limit"   />
				            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">VaR Limit :</label>
				            <div class="col-xs-8">		
					            <input type="text" class="form-control dialog-limit" data-field="var_limit" maxlength="20" data-format="n6" placeholder="Enter equity VaR limit"   />
				            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <form id="formUpload">
                <div class="col-xs-12">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Equity Limit CSV File :</label>
				            <div class="col-xs-8">		
...
<pre class="code">
    ...
    <code></code>
    <code>"FUND_CODE","ASOF","EQ_LIMIT_MIN","EQ_LIMIT_MAX","EQ_VAR_LIMIT"</code>
    <code>"XXX","dd/MM/yyyy","0.00","0.0000",""</code>
    <code></code>
    <code>Ex.</code>
    <code>"BTP","01/03/2018","0.85","0.9775",""</code>
    <code>"BCAP","31/10/2017","0","1","10"</code>
    <code>...</code>
    <code></code>
</pre>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script src="<% =ResolveUrl("scripts/equity.js")%>"></script>
</asp:Content>
