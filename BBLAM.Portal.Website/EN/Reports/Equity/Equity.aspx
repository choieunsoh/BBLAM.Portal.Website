<%@ Page Title="Equity Report" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="BBLAM.Web.UI.PageBase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-xs-12">
            <div class="heading-title">
                <h4>
                    <i class="fa fa-pie-chart"></i> Equity Report
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <div id="gridDelta" class="grid-xs"></div>
        </div>
    </div>
