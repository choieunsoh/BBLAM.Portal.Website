<%@ Page Title="Calc Port Return" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="BBLAM.Web.UI.PageBase" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="heading-title">
                <h4>
                    <i class="fa fa-line-chart"></i> Calc Portfolio Return
                </h4>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="form-horizontal">
                    <div class="form-group search-group">
				        ...
				        <div class="col-xs-8">		
					        <select class="selectpicker show-tick" data-field="fund_type" title="Please select fund type" data-width="100%">
                                <option value="MF">Mutual Funds</option>
                                <option value="PVD">Provident Funds</option>
                                <option value="PF">Private Funds</option>
                            </select>
				        </div>
                    </div>
                </div>
                ...
                <div class="form-horizontal">
                    <div class="form-group search-group">
                        <div class="col-xs-offset-4 col-xs-8">
                            ...
                            <button id="btnCalc" class="btn btn-danger"><i class="fa fa-play"></i> Calc Port Return</button>
                        </div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script src="<% =ResolveUrl("scripts/port-return.js")%>"></script>
</asp:Content>
